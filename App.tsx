      ...
      case GamePhase.GAME_OVER:
        return (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-red-950/80 text-white z-10 backdrop-blur-md">
            ...
            <p className="text-xl mb-8 text-red-200 font-mono">
              SYSTEM FAILURE
            </p>
            <button
              onClick={handleStart}
      ...
      case GamePhase.VICTORY:
        return (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-fuchsia-950/80 text-white z-10 backdrop-blur-md">
            ...
            <p className="text-xl mb-8 text-fuchsia-200 tracking-widest">
              BOSS DESTROYED
            </p>
      ...
      <div className={containerClass}>
        ...
        <div className="absolute top-6 right-6 z-20 pointer-events-auto">
          <div className="flex items-center gap-2 bg-black/60 backdrop-blur-sm border border-cyan-500/30 px-2 py-2">
            <button
              ...
              className={`px-3 py-1 text-xs font-mono tracking-widest ${
                orientation === "auto"
        ...
        <div className="absolute top-6 left-6 z-0 pointer-events-none">
          <div className="flex items-center gap-3 bg-black/60 backdrop-blur-sm px-5 py-2 border-l-4 border-cyan-500 shadow-[0_0_10px_rgba(6,182,212,0.3)] skew-x-[-10deg]">
            ...
            <span className="text-3xl font-bold text-white font-mono skew-x-[10deg] drop-shadow-[0_0_5px_rgba(0,255,255,0.8)]">
              {score}
            </span>
          </div>
        </div>
        ...
        {phase === GamePhase.BOSS_FIGHT && bossInfo && (
          <div className="absolute top-6 right-6 z-0 pointer-events-none">
            <div className="flex flex-col items-end">
              <span className="text-fuchsia-500 font-bold text-xs tracking-widest mb-1 shadow-black drop-shadow-md">
                BOSS INTEGRITY
              </span>
                ...
                <div className="h-4 w-32 bg-gray-900 border border-fuchsia-900 skew-x-[-15deg] overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${Math.min(
                        100,
                        (bossInfo.currentHp / bossInfo.maxHp) * 100
                      )}%`,
                    }}
                  ></div>
                </div>
